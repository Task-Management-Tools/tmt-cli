...
class ZipFileHander:
    ...
    @classmethod
    def _list_file_parents(cls, file_path: os.PathLike):
        assert not str(file_path).endswith("/")
    ...
    def _make_zipinfo(self, filename: str, mode: int):
