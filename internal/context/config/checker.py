    ...
    match type_:
        ...
        case CheckerType.DEFAULT:
            ...
            return parser.errors or CheckerDefault(
                type=type_,
                filename=filename,
                arguments=check_error(arguments).split(),
                check_forced_output=check_error(check_forced_output),
                check_generated_output=check_error(check_generated_output),
            )
