    ...
    *,
    ...
    if print_subtask:
        for subtask_name, subtask in subtask_list.items():
            ...
            score, result_str, verdict_count = _get_tests_outcome(result.testcase_results, subtask.get_all_test_names())
            ...
            verify_fail_msg += _check_verdict_rule(
    ...
    # Overall outcome
    score, result_str, verdict_count = _get_tests_outcome(
