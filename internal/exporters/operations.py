    ...
    def execute(self, formatter: Formatter, context: TMTContext, output_folder: Path) -> None:
        ...
        for file_path in matching_files:
            if self.keep_original_name:
                ...
                if self.rename_func:
                    target_name = self.rename_func(formatter, context, [file_path], supplementary_files)
                else:
                    target_name = file_path.name
            ...
            if self.custom_func:
                with open(target_file, 'w') as output_file:
                    self.custom_func(formatter, context, [file_path], supplementary_files, output_file)
            else:
