...
def yaml_converter(formatter: Formatter, context: TMTContext, source_files: List[Path], output_file: IO) -> None:
    """
...
class ICPCExporter(FolderFormatExporter):
    ...
    def setup_operations(self, formatter: Formatter, context: TMTContext):
        ...
        """Setup submissions"""
        def recognize_verdict(formatter: Formatter, context: TMTContext, matched_files: List[Path], supplementary_files: List[Path]) -> str:
